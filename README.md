...
- [x] Fase 2 — UI base (Sidebar flat + MapView por marca + StationDetail con badges de fuente)
- [x] Fase 3 — Comparador multi-estación (selección de hasta 4)
- [~] Fase 4 — Ingesta de fuentes reales gratuitas (en curso)
  - [x] MITECO (C3 precios) — `scripts/fetch_miteco.py`
  - [ ] Catastro (C4) · INE+Eustat (C2) · Aforos DGT (C5) · OpenChargeMap+OSM (C3 EV+POIs)
  - [ ] IMP/Scores/Recomendación derivados
